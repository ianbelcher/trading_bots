...
#define PROGRAM_VERSION "v0 800" //Hourly bartype betting
...
void order_addsignaturetoorder(int FUNCGET_target){
   ...
   ORDERS_signature[ORDERS_currentnumberoforders] = SIGN_barnumber;
   ORDERS_target[ORDERS_currentnumberoforders] = GLOBAL_targetpercentages[FUNCGET_target];
   ORDERS_tested_targetdistance[ORDERS_currentnumberoforders] = getinfo(7, SIGN_pair, GLOBAL_timeframe, ORDERS_barnumber) * GLOBAL_targetpercentages[FUNCGET_target];
   ORDERS_tested_price[ORDERS_currentnumberoforders] = getinfo(1, SIGN_pair, GLOBAL_timeframe, ORDERS_barnumber);
   ORDERS_tested_endprice[ORDERS_currentnumberoforders] = getinfo(4, SIGN_pair, GLOBAL_timeframe, ORDERS_barnumber);

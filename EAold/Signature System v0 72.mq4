...
extern int     GLOBAL_recentlookback         = 7500000;        //In Seconds. For the RECENT sub-signature, this is the lookback. 2.6M is about one month.
...
extern int     GLOBAL_goalspreadfactor       = 10;              //Minimum target needs to be this many times the spread to negate its effects.
...
void signature_setsignaturearray(string FUNCGET_signature, string FUNCGET_pair, int FUNCGET_barnumber = 0){
   ...
   for(a=0;a<CURRENCY_numberofpairs;a++){
      FUNCVAR_currentpair = CURRENCY_allpairs[a];
       for(FUNCVAR_barnumber=FUNCGET_barnumber + 2;FUNCVAR_barnumber < CURRENCY_allpairslookback[a]-2;FUNCVAR_barnumber++){ //Start looking at data 2 bars back from the bar we're looking at and 2 bars before the end of the data
...
void testing_runtests(){
   ...
   //Returns a report on the trades which would have been taken in the last number of days
      testing_outputdemonumberofdays(20);

...
int init(){
   ...
   global_lookback = 60 * (YEAR * 5);
   global_lookforward = 1;
...
void out_barstats(string pair = "NULL"){
   ...
   while(getinfo(5, pair, global_timeframe, funcvar_barnumber) > (TimeCurrent() - global_lookback + global_lookforward)){
      funcvar_introunder1 = getinfo(9, pair, global_timeframe, funcvar_barnumber + 1);
      funcvar_introunder2 = getinfo(9, pair, global_timeframe, funcvar_barnumber);
      FileWrite(funcvar_file, 
         ...
         "=(RC[-5]-RC[-4])/RC[-1]",
         "1"+funcvar_introunder1+""+funcvar_introunder2,
         "",
         "=RC[-3]*R1C16",
         "=(RC[-7]-RC[-11])/RC[-5]",
         "=(RC[-10]-RC[-12])/RC[-6]",
         "",
         "=IF(RC[-2]>RC[-4],1,0)",
         "=IF(RC[-3]>RC[-5],1,RC[-4]/RC[-5])",
         "",
         "=INT(SUMIF(R1C[-9]:R200000C[-9],RC[-9],R1C[-2]:R200000C[-2])/COUNTIF(R1C[-9]:R200000C[-9],RC[-9])*100)",
         "=INT(SUMIF(R1C[-10]:R200000C[-10],RC[-10],R1C[-4]:R200000C[-4])/COUNTIF(R1C[-10]:R200000C[-10],RC[-10])*100)",
         "",
         "=(RC[-20]-RC[-16])/RC[-14]",
         "=(RC[-21]-RC[-18])/RC[-15]",
         "",
         "=IF(RC[-2]>RC[-13],1,0)",
         "=IF(RC[-3]>RC[-14],1,RC[-4]/RC[-14])",
         "",
         "=INT(SUMIF(R1C[-18]:R200000C[-18],RC[-18],R1C[-2]:R200000C[-2])/COUNTIF(R1C[-18]:R200000C[-18],RC[-18])*100)",
         "=INT(SUMIF(R1C[-19]:R200000C[-19],RC[-19],R1C[-4]:R200000C[-4])/COUNTIF(R1C[-19]:R200000C[-19],RC[-19])*100)"
      );

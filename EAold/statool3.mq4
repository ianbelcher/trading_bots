...
void out_movement(string pair = "NULL", int length_factor = 0){
   ...
   while(getinfo(5, pair, global_timeframe, funcvar_barnumber) > (TimeCurrent() - global_lookback + global_lookforward)){
      ...
      if(
         //funcvar_gradient < -1 * funcvar_factor * length_factor &&
         getinfo(601, pair, global_timeframe, funcvar_barnumber) == 1 &&
         getinfo(601, pair, global_timeframe, funcvar_barnumber + 1) == 0
      ){
         funcvar_stringtoadd = "";
         for(a = 1 ; a <= global_lookforward; a=a+1){
            funcvar_stringtoadd = 
            ...
            (iClose(pair, global_timeframe, funcvar_barnumber)/ funcvar_point - iClose(pair, global_timeframe, funcvar_barnumber- a) / funcvar_point) +";"+
            getinfo(601, pair, global_timeframe, funcvar_barnumber - a) +";"+
            ""+";"+
            "";
         }
         FileWrite(funcvar_file, 

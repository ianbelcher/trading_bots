...
extern double  GLOBAL_goalminrating          = 0.5;            //The minimum expected ROI on a trade 
...
void signature_dumpsignaturearray(){
   ...
   int
      ...
      ;
   log("pair;sig;barnumber;targetpercentage;datemin;datemax;recentcases;recentresult;totalcases;totalresult;NIC;NIR;PC;PR");     
...
string order_arrayrecordastext(int FUNCGET_recordnumber){
   ...
   string FUNCVAR_text = 
      ...
      humandate(ORDERS_recent_datemin[FUNCGET_recordnumber])+";"+
      humandate(ORDERS_recent_datemax[FUNCGET_recordnumber])+";"+
...
void init_resetfiles(){
   ...
   if(GLOBAL_isdemo == true){
      ...
      string FUNCVAR_ordersheaderarray[1] = {"date;date;bar;pair;spread;signature;target;Rrte;Rrslt;Rcss;Rdmin;Rdmax;Trte;Trslt;Tcss;NIrte;NIrlt;NIcss;Prte;Prlt;Pcss;ticket;cmd;price;vol;sl;tp;cmnt;mn;target;t+ve;t-ve;risk;price;endprice;win"};
...
void testing_runtests(){
   ...
   //Returns a report on the trades which would have been taken in the last number of days
      testing_demonumberofperiods(120);
...
void testing_demonumberofperiods(int FUNCGET_days = 1, int FUNCGET_startbar = 1){
